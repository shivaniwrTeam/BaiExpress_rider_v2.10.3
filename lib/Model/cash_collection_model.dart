...
class CashColl_Model {
  ...
  factory CashColl_Model.fromJson(Map<String, dynamic> parsedJson) {
    var orderDetailsJson = parsedJson['order_details'];

// Check if 'order_details' is a String and is empty, then assign an empty List.
    var ordDet = orderDetailsJson is String && orderDetailsJson.isEmpty
        ? []
        : (orderDetailsJson as List);

    /*  var ordDet = parsedJson['order_details'] == ""
        ? []
        : (parsedJson['order_details'] as List); */
