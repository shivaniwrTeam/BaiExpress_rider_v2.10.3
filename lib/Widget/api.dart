...
final Uri getReturnOrderApi = Uri.parse(baseUrl + 'view_return_order_items');
final Uri ReturnOrderYUpdateStatus =
    Uri.parse(baseUrl + 'update_return_order_item_status');
final Uri getResetPassApi = Uri.parse(baseUrl + 'reset_password');
final Uri updateOrderConsignmentStatus =
    Uri.parse(baseUrl + 'update_order_consignment_status');
